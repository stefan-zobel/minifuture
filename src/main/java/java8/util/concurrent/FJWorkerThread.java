...
// CVS rev. 1.78
    ...
    FJWorkerThread(FJPool pool, ClassLoader ccl) {
        ...
        TLR.setContextClassLoader(this, ccl);
        this.pool = pool;
     ...
     */
    FJWorkerThread(FJPool pool,
                         ClassLoader ccl,
                         ThreadGroup threadGroup,
                         AccessControlContext acc) {
        super(threadGroup, NAME_PLACEHOLDER);
        super.setContextClassLoader(ccl);
        TLR.setInheritedAccessControlContext(this, acc);
        TLR.eraseThreadLocals(this); // clear before registering
        this.pool = pool;
        this.workQueue = pool.registerWorker(this);
    }
     ...
     */
    static final class InnocuousForkJoinWorkerThread extends FJWorkerThread {
        ...
        InnocuousForkJoinWorkerThread(FJPool pool) {
            super(pool,
