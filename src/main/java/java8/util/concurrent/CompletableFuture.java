...
// CVS rev. 1.225
     ...
     * @since 1.8
     */
    static interface AsynchronousCompletionTask {
    }
...
//                }
    ...
    public boolean completeExceptionally(Throwable ex) {
        boolean triggered = internalComplete(new AltResult(Util.requireNonNull(ex)));
        postComplete();
        return triggered;
    }
     ...
     */
    public void obtrudeException(Throwable ex) {
        result = new AltResult(Util.requireNonNull(ex));
        postComplete();
    }
     ...
     */
    public static Executor delayedExecutor(long delay, TimeUnit unit) {
        return new DelayedExecutor(delay, Util.requireNonNull(unit), ASYNC_POOL);
    }
    ...
    public static <U> CompletableFuture<U> failedFuture(Throwable ex) {
        return new CompletableFuture<U>(new AltResult(Util.requireNonNull(ex)));
    }
    ...
    public static <U> CompletionStage<U> failedStage(Throwable ex) {
        return new MinimalStage<U>(new AltResult(Util.requireNonNull(ex)));
    }
